...
Based off of [jonochang's improvements](https://github.com/jonochang/wicked_pdf), a wicked_pdf gem is in development.
...
To save the pdf while rendering, use the :save_to_file option and specify a path.  Using the :save_only option will save the file and render without a layout.
